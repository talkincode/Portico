...
- 提供只读治理工具（如 `portico_list`、`portico_describe`、`portico_dashboard`、`portico_approvals`、`portico_identities`、`portico_grants`、`portico_whoami`、`portico_sessions`、`portico_credentials`、`portico_page` 等），使其他 Agent 能以符合 MCP 规范的标准协议发现同伴服务。
